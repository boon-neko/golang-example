...
var UserWhere = struct {
	...
	ID:        whereHelperstring{field: "`users`.`uuid`"},
	Name:      whereHelperstring{field: "`users`.`name`"},
	Role:      whereHelperint{field: "`users`.`role`"},
...
func (r *userR) GetUserBookSubscriptions() UserBookSubscriptionSlice {
	if r == nil {
		return nil
	}
...
var (
	userAllColumns            = []string{"uuid", "name", "role", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"uuid", "name", "role"}
...
func (o *User) UserBookSubscriptions(mods ...qm.QueryMod) userBookSubscriptionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`user_book_subscription`.`user_id`=?", o.ID),
	)
...
func (userL) LoadUserBookSubscriptions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_book_subscription.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddUserBookSubscriptionsG(ctx context.Context, insert bool, related ...*UserBookSubscription) error {
...
// Sets related.R.User appropriately.
// Panics on error.
func (o *User) AddUserBookSubscriptionsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserBookSubscription) {
...
func (o *User) AddUserBookSubscriptionsGP(ctx context.Context, insert bool, related ...*UserBookSubscription) {
...
// Appends related to o.R.UserBookSubscriptions.
// Sets related.R.User appropriately.
func (o *User) AddUserBookSubscriptions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserBookSubscription) error {
	var err error
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from `users` where `uuid`=?", sel,
	)
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `users` where `uuid`=? limit 1)"
